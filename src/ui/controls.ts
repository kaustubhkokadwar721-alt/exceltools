...
// HTML strings (the data grid's virtualised rows, the help panel, a few loading
// messages) must run every non-literal value through this first — file names and
// URL fragments are attacker-controlled. It lives in core/escape so the parser
// worker can share the one implementation; re-exported here for the DOM code.
export { escapeHtml } from '../core/escape';
