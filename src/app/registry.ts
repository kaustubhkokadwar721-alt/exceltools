...
export const TOOLS: ToolDef[] = [
  ...
  { id: 'merge', title: 'Merge', blurb: 'Combine multiple workbooks or sheets into one.', icon: '⧉', tier: 'light', status: 'planned' },
  { id: 'split', title: 'Split', blurb: 'Split one sheet into many by rows or a column value.', icon: '✂', tier: 'light', status: 'planned' },
  { id: 'dedupe', title: 'Clean & Dedupe', blurb: 'Remove duplicates, blank rows, and trim values.', icon: '🧹', tier: 'light', status: 'planned' },
  { id: 'compare', title: 'Compare', blurb: 'Diff two spreadsheets side by side.', icon: '⇌', tier: 'light', status: 'planned' },
